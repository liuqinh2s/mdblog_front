  ...
  export default {
    ...
    data() {
      ...
      let checkImageCode = function (rule, value, callback) {
        that.$http.post('http://mdblog.club:80/user/sendImageCode?imageCode=' + value).then((res) => {
          console.log(res);
    ...
    methods: {
      refreshImageCode() {
        ...
        this.$http({
          method: 'get',
          url: 'http://mdblog.club:80/user/imageCode',
          responseType: "blob"
        }).then((res) => {
          console.log(res);
      ...
      login() {
        ...
        this.$refs.loginForm.validate((valid) => {
          if (valid) {
            ...
            /*接口请求*/
            that.$http.post('http://mdblog.club:80/user/login', data).then((res) => {
              console.log(res);
              if (res.data.code === 200) {
                this.$router.push("/home")
              }
      ...
      register() {
        ...
        this.$refs.registerForm.validate((valid) => {
          if (valid) {
            ...
            this.loading = true
            /*接口请求*/
            this.$http.post('http://mdblog.club:80/user/register', data).then((res) => {
              console.log(res);
              this.loading = false
              if (res.data.code !== 200) {
      ...
      sendVerifyCode() {
        ...
        /*接口请求*/
        this.$http.get('http://mdblog.club:80/user/verifyCode?mobile=' + this.ruleForm.mobile).then((res) => {
          console.log(res);
          // 验证码60秒倒计时

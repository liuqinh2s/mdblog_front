  ...
  export default {
    ...
    data() {
      ...
      let checkImageCode = function (rule, value, callback) {
        that.$http.post('https://localhost/user/sendImageCode?imageCode=' + value).then((res) => {
          console.log(res);
    ...
    methods: {
      refreshImageCode() {
        ...
        this.$http({
          method: 'get',
          url: 'https://localhost/user/imageCode',
          responseType: "blob"
        }).then((res) => {
          console.log(res);
      ...
      login() {
        ...
        this.$refs.loginForm.validate((valid) => {
          if (valid) {
            ...
            /*接口请求*/
            that.$http.post('https://localhost/user/login', data).then((res) => {
              console.log(res);
              if (res.data.code === 200) {
                this.$router.push("/home")
              }
      ...
      register() {
        ...
        this.$refs.registerForm.validate((valid) => {
          if (valid) {
            ...
            this.loading = true
            /*接口请求*/
            this.$http.post('https://localhost/user/register', data).then((res) => {
              console.log(res);
              this.loading = false
              if (res.data.code !== 200) {
      ...
      sendVerifyCode() {
        ...
        /*接口请求*/
        this.$http.get('https://localhost/user/verifyCode?mobile=' + this.ruleForm.mobile).then((res) => {
          console.log(res);
          // 验证码60秒倒计时

  ...
  export default {
    ...
    methods: {
      getSubBooks(item) {
        ...
        this.$http.post("http://192.168.1.151:8080/api/v1/article/getSubArticles", data).then((res) => {
          console.log(res)
      ...
      deleteBook(item) {
        ...
        this.$http.post("http://192.168.1.151:8080/api/v1/book/deleteBook", data).then((res) => {
          console.log(res)
          if (res.data.code === 200) {
            this.selectedBook = -1
            data = {
      ...
      rename() {
        ...
        if (this.type === "book") {
          ...
          this.$http.post("http://192.168.1.151:8080/api/v1/book/changeBookName", data).then((res) => {
            console.log(res)
            if (res.data.code === 200) {
              this.selectedBook = -1
              data = {
          ...
          this.$http.post("http://192.168.1.151:8080/api/v1/article/changeArticleName", data).then((res) => {
            console.log(res)
            if (res.data.code === 200) {
              this.selected = -1
              data = {

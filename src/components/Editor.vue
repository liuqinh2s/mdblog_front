...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showBooks() {
        this.$http.post("http://104.129.182.209:8080/api/v1/article/getAllTopBooks", {userId: "0c037d72-0455-4496-9529-568aed59bd5a"}).then((res) => {
          console.log(res);
        })
      },
      getHtml(article) {
      ...
      saveArticle() {
        ...
        console.log(data)
        this.$http.post("http://104.129.182.209:8080/api/v1/article/saveArticle", data).then((res) => {
          console.log(res);
        });
      },
      deleteArticle() {
        ...
        this.$http.post("http://104.129.182.209:8080/api/v1/article/deleteArticle", data).then((res) => {
          console.log(res)
      ...
      publish() {
        ...
        this.$http.post("http://104.129.182.209:8080/api/v1/article/publish", data).then((res) => {
          console.log(res)
      ...
      publishCancel() {
        ...
        this.$http.post("http://104.129.182.209:8080/api/v1/article/publishCancel", data).then((res) => {
          console.log(res)
          if (res.data.code === 200) {
      ...
      searchTag() {
        this.$http.get("http://104.129.182.209:8080/api/v1/tag/searchTag?keyword=" + this.tags).then((res) => {
          console.log(res)
          this.items = res.body
        })
      },
      addTag(item) {
        ...
        spanX.onclick = function () {
          ...
          that.$http.post("http://104.129.182.209:8080/api/v1/tag/removeTag", data).then((res) => {
            console.log(res)
          })
        }
        ...
        this.$http.post("http://104.129.182.209:8080/api/v1/tag/addTag", data).then((res) => {
          console.log(res)
          if(res.data.code===200){

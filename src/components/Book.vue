  ...
  export default {
    ...
    methods: {
      getSubBooks(item) {
        ...
        this.$http.post("https://mdblog.club:8443/article/getSubArticles", data).then((res) => {
          console.log(res)
      ...
      back() {
        ...
        this.$http.post("https://mdblog.club:8443/book/getSupBooks", data).then((res) => {
          console.log(res)
          this.$store.commit('setBooks', res.data)
          this.$store.commit('setIsSub', this.$store.state.isSub - 1)
      ...
      deleteBook(item) {
        ...
        this.$http.post("https://mdblog.club:8443/book/deleteBook", data).then((res) => {
          console.log(res)
          if (res.data.code === 200) {
            this.selectedBook = -1
            data = {
      ...
      rename() {
        ...
        if (this.type === "book") {
          ...
          this.$http.post("https://mdblog.club:8443/book/changeBookName", data).then((res) => {
            console.log(res)
            if (res.data.code === 200) {
              this.selectedBook = -1
              data = {
          ...
          this.$http.post("https://mdblog.club:8443/article/changeArticleName", data).then((res) => {
            console.log(res)
            if (res.data.code === 200) {
              this.selected = -1
              data = {

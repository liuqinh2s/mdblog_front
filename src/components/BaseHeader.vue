  ...
  export default {
    ...
    methods: {
      ...
      gotoEditor() {
        ...
        console.log(data)
        this.$http.post("http://192.168.1.101:8080/api/v1/article/createArticle", data).then((res) => {
          console.log(res)
          if (res.data === "请先登录") {
    ...
    mounted() {
      ...
      this.$http.get("http://192.168.1.101:8080/api/v1/article/getUserId").then((res)=>{
        console.log(res)
